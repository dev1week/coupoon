...
import static com.board.couponcore.exception.ErrorCode.INVALID_COUPON_ISSUE_DATE;
import static com.board.couponcore.exception.ErrorCode.INVALID_COUPON_ISSUE_QUANTITY;
...
public class Coupon extends BaseTimeEntity{
    ...
    public void issue(){
        if(!availableIssueQuantity()){
            throw new CouponIssueException(INVALID_COUPON_ISSUE_QUANTITY, "발급 가능한 수량을 초과하였습니다. total : %s, issued : %s".formatted(totalQuantity, issuedQuantity));
        }
